<?php  //[STAMP] cc430f3f99cb24ba3eabd097b8b35d03
...
trait AcceptanceTesterActions
{
     ...
     *
     *
     * @see \Helper\Acceptance::switchToIframeByCssSelector()
     */
    public function switchToIframeByCssSelector($locator) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('switchToIframeByCssSelector', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Acceptance::testTrue()
     */
    public function testTrue($condition, $message) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('testTrue', func_get_args()));
    }
}
